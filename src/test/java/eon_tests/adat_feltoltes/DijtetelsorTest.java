...
public class DijtetelsorTest {
    ...
    public void alapAdatFeltoltes(String felhNev, String jelszo, String dijtetelsorNev, String gepNev, int gepOradij, String gep2Megnevezes, int gep2Oradij, String humanNev, int humanOradij, String human2Megnevezes, int human2Oradij, int fSorszam, String fMegnevezes, String fRovidnev, int fGepszorzo, int fHumanszorzo) throws IOException {
    ...
    @Test
    public void alapAdatFeltoltesFeltoltes1Uid8e79a5e3d68a47f0bca9859991a1c6ec() throws IOException {
